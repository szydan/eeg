...
(function (window, $, d3) {
  ...
  function Eeg(selector, opt) {
    ...
    this.options.showLegend = opt.showLegend !== undefined ? opt.showLegend : true;
    ...
    this.options.onNodeSticky    = opt.onNodeSticky    || function (self, THIS, d, i, clickedEl) {
      $(clickedEl).closest('div.nodeContextMenu').fadeOut();
    };
    this.options.onNodeUnsticky  = opt.onNodeUnsticky  || function (self, THIS, d, i, clickedEl) {
      $(clickedEl).closest('div.nodeContextMenu').fadeOut();
    };
    ...
    this.options.onNodeExpand      = opt.onNodeExpand       || function (self, THIS, d, i, clickedEl) {
