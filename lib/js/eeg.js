...
Eeg.prototype = (function(){
  ...
  function _drawLegend(){
    ...
    function _addSingleLink(link){
        ...
        var htmlElement = link.htmlElement;
        var htmlElementWidth = link.htmlElementWidth;
        var htmlElementHeight = link.htmlElementHeight;
  ...
  function _update(){
    ...
    var linkTextForeign = this.vis.select("#linksLabelsLayer").selectAll("g.linkText").filter(function (d) {
    ...
    .attr("width", function (d) {
      return d.htmlElementWidth || 100;
    })
    .attr("height", function (d) {
      return d.htmlElementHeight || 20;
    })
    .attr("id", function(d){
    ...
    var linkText = this.vis.select("#linksLabelsLayer").selectAll("text.linkText").filter(function (d) {
